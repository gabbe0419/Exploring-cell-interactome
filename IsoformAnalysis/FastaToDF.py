...
class FastaToDF:
    def __init__ (self, file_path):
        ...
        for record in SeqIO.parse(self.file_path, "fasta"):
            ...
            data.append({
                ...
                "isoform_of": self.extract_isoform_of(description),
                "functional_traits": self.extract_functional_traits(description),
                "organism_name": self.extract_organism_name(description),
                "gene_name": self.extract_gene_name(description),
                "protein_sequence": str(record.seq)
            })

        self.fasta = pd.DataFrame(data)   
    
    def extract_isoform_of(self, description: str) -> str:
        """
    ...
    def extract_functional_traits(self, description: str) -> str:
        """
    ...
    def extract_organism_name(self, description: str) -> str:
        """
    ...
    def extract_gene_name(self, description: str) -> str:
        """
